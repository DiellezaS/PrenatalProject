<template>
  <div>
    ...
    <div class="sm:w-1\4" v-if="!isMobile">
    ...
    <div v-else>
      ...
      <button data-drawer-target="default-sidebar" @click="toggleDropdown" data-drawer-toggle="default-sidebar" aria-controls="default-sidebar" type="button" class="inline-flex items-center p-2 mt-2 ms-3 border-2 w-1/3 text-sm text-gray-500 rounded-lg sm:hidden hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-gray-200 dark:text-gray-400 dark:hover:bg-gray-700 dark:focus:ring-gray-600">
